      ...
      <div className='px-20 py-10'>
        ...
        <div className='flex flex-row w-100'>
          ...
          <div className='flex-grow'>
            <SimpleInput label='judul project' placeholder='judul project' className='mb-4' />
            <label className="w-full text-start capitalize">deskripsi singkat project</label>
            <textarea placeholder="deskripsi singkat project" name='biodata'  className="mb-4 textarea textarea-bordered textarea-lg w-full h-64 no-resize"></textarea>
            <div className='flex justify-between'>
              <div className='flex-grow mr-8'>
                <SimpleInput label={<><i className="fa-solid fa-play mr-1"></i> demo link</> } placeholder='demo link' className='mb-4' />
              </div>
              <div className='flex-grow'>
                <SimpleInput label={<><i className="fa-brands fa-github mr-1"></i> source code</>} placeholder='source code' className='mb-4' />
              </div>
            </div>
